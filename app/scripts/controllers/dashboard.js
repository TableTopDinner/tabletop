    ...
    $scope.createRestaurant = function() {
      ...
      //If there are missing field errors alert that silly restaurant owner
          ...
          if (err.message === "Cannot read property 'name' of undefined") {
              document.getElementById('missingFieldError').innerHTML = "<div class='alert alert-danger'> <strong>Hey you mighty restaurant owner!</strong> Please give your restaurant a name.";
          }
          if (err.message === "Firebase.set failed: First argument contains undefined in property 'name'") {
              document.getElementById('missingFieldError').innerHTML = "<div class='alert alert-danger'> <strong>Hey you mighty restaurant owner!</strong> Please give your res a name.";
          }
      }
    };
});
